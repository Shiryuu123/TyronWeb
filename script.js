...
const initProjectModal = () => {
    ...
    const projectDetails = {
        ...
        'Payroll System': {
            ...
            description: 'Automates salary and employee records management with ease and accuracy.',
            details: 'A robust payroll management system that handles employee records, salary calculations, tax deductions, and generates comprehensive payroll reports.',
        ...
        'HEED: Psychological Games': {
            ...
            description: 'A collection of engaging psychological games designed to improve attention span and reduce excessive screen time.',
            details: 'An interactive game suite featuring various psychology-based games designed to enhance cognitive abilities and promote digital wellness.',
            technologies: ['Game Development', 'Psychology'],
            features: ['Multiple games', 'Progress tracking', 'Engaging UI', 'Health benefits']
        }
    };
